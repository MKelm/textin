...
textin_sdl : textin_sdl.o textlist.o timer.o espeak.o scorelist.o
	$(CC) textin_sdl.o textlist.o timer.o espeak.o scorelist.o -o textin_sdl.$(ARCH) $(LDFLAGS)
...
textin_sdl.o : textin_sdl.c textlist.h timer.h espeak.h scorelist.h global.h
